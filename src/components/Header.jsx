...
const Header = (sideBarCollapsed, onToggleSideba) => {
  return (
    <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-b border-slate-200/50 dark:border-slate-700/50 px-6 py-4">
      <div className="flex items-center justify-between">
        {/* Left */}
        <div onClick={onToggleSideba} className="flex items-center space-x-4">
          ...
          <div className="hidden md:block">
            ...
            <p className="text-slate-500 dark:text-slate-400">
              Welcome back Sirojiddin, here is what is happening today
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="flex items-center space-x-3 pl-3 border-l border-slate-200 dark:border-slate-700">
            <img
              src="https://img.freepik.com/free-photo/bohemian-man-with-his-arms-crossed_1368-3542.jpg?w=740&q=80"
              alt="user"
